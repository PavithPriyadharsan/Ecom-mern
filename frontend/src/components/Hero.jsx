...
const Hero = () => {
  return (
    <section className="relative bg-hero bg-cover bg-no-repeat h-screen w-full">
        <div className="max_padd_container relative top-32 xs:top-50 md:top-28">
            <h1 className="h1 capitalize max-w-[37rem]">Digital Shopping Hub Junction</h1>
            <p className="text-gray-50 regular-16 mt-6 max-w-[33rem]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis eos quae delectus, dolores, ratione facilis minus nulla, ipsam harum dicta illum explicabo. Minima vitae dicta corrupti id. Nihil, libero repudiandae.</p>
            <div className="flexStart !items-center gap-x-4 my-10">
                <div className="irregular-24 flexCenter gap-x-3">
                    <FaStar />
                    <FaStar />
                    <FaStar />
                    <FaStar />
